...
class SubThenFilter:
    def __init__(self):
        self.sub = rospy.Subscriber("/camera/depth/image_raw", Image, self.image_callback,queue_size=1)
        self.pub = rospy.Publisher("depth/image_filtered", Image,queue_size=1)
